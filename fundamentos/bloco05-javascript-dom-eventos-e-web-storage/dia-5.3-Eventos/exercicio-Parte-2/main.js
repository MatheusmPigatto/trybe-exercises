...
// 1.2. Note que uma das caixas está um pouco acima das outras. Por que isso ocorre? Por causa do alterar a primeira tecnologia

// 2. Crie uma função que adicione a classe 'tech' ao elemento `li` quando for clicado.
// 2.1. Deve existir apenas um elemento com a classe 'tech'. Como você faz isso?
function addTech (event) {
    const tat = document.querySelector('.tech');
    event.target.className = 'tech'
    tat.classList.remove('tech')
}
...
function redirect() {
    window.location.href = 'https://matheusmpigatto.github.io/';
}   
